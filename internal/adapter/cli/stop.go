...
// NewStopCommand cria o comando "oi stop"
func NewStopCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "stop",
		Short: "Para containers (pause)",
		Long:  `Para containers em execução sem removê-los. Use oi start para reiniciar.`,
